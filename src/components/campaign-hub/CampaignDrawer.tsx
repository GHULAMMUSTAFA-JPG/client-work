            ...
            <div className="tw-flex tw-h-full tw-flex-col tw-bg-white tw-shadow-xl">
              ...
              <div className="tw-flex-1 tw-overflow-y-auto">
                <div className="tw-px-6 tw-py-4">
                  ...
                  <div className="tw-mb-6">
                    ...
                    <div className="tw-space-y-3">
                      ...
                      <div className="tw-flex tw-items-center tw-justify-between tw-text-sm">
                        ...
                        <span className="tw-font-medium tw-text-gray-900">
                          {initialData?.dueDate || "No due date"}
                        </span>
                      </div>
                      {initialData?.goLiveDate && (
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-sm">
                          <div className="tw-flex tw-items-center tw-text-gray-500">
                            <Globe className="tw-w-4 tw-h-4 tw-mr-2" />
                  ...
                  {initialData?.status === "needs_updates" &&
                            ...
                            <div className="tw-flex-1">
                              {Array.isArray(initialData.feedback) ? (
                                <ul className="tw-space-y-2">
                                  {initialData.feedback.map(
                                    (item: string, index: number) => (
                                      <li
                                        key={index}
                                        className="tw-text-sm tw-text-orange-700"
                                      >
                                        {item}
                                      </li>
                                    )
