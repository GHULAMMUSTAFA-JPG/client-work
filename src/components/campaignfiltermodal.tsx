...
export default function CampaignFilterModal({ selectedCampaign }: { selectedCampaign: Campaign }) {
    ...
    const offcanvasInstanceRef = useRef<Offcanvas | null>(null); // ✅ Store Offcanvas instance

    useEffect(() => {
        if (offcanvasRef.current) {
            // ✅ Initialize the Offcanvas instance only if it's not already created
        ...
        return () => {
            ...
            if (offcanvasInstanceRef.current) {
                ...
                offcanvasInstanceRef.current.dispose(); // ✅ Properly dispose of instance
                offcanvasInstanceRef.current = null; // ✅ Reset instance
            }
        };
    }, [selectedCampaign]); // Runs only when `selectedCampaign` changes
        ...
        >
            <div className="offcanvas-header border-bottom">
                <div>
                    ...
                    <p className="text-muted fs-12 mb-0">Campaign Details</p>
                </div>
                <button
                    type="button"
                    className="btn-close"
            ...
            <div className="offcanvas-body">
                <div className="mb-3">
                    <img
                        src={selectedCampaign?.Campaign_Media}
                        alt="Campaign"
                ...
                <p className="text-muted fs-14">{selectedCampaign?.Brief_Description}</p>
                ...
                <div className="mb-3">
                    <strong>Start Date:</strong> {selectedCampaign?.Start_Date}
                </div>
                <div className="mb-3">
                    <strong>End Date:</strong> {selectedCampaign?.Is_Ongoing ? "Ongoing" : selectedCampaign?.End_Date}
                </div>

                <div className="mb-3">
                    <strong>Details:</strong>
                    <p className="text-muted">{selectedCampaign?.Campaign_Details.replace(/\n/g, " ")}</p>
                </div>

                <div className="mb-3">
                    <strong>Target Audience:</strong>
                    <div>
                        {selectedCampaign?.Target_Audience.map((audience: string, index: number) => (
                ...
                <div className="mb-3">
                    ...
                    <a href={selectedCampaign?.Company_Website} target="_blank" rel="noopener noreferrer">
                ...
                <div className="mb-3">
                    ...
                    <a href={selectedCampaign?.Company_Linkedin} target="_blank" rel="noopener noreferrer">
