            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-12">
                  <ul
                    className="nav nav-underline mx-2 border-bottom"
                    id="myTab"
                    role="tablist"
                  >
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        id="user1-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#user1-tab-pane"
                        type="button"
                        role="tab"
                        aria-controls="user1-tab-pane"
                        aria-selected="false"
                      >
                        Search
                      </button>
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        ...
                        id="profile1-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#profile1-tab-pane"
                        type="button"
                        role="tab"
                        aria-controls="profile1-tab-pane"
                        aria-selected="false"
                      >
                        Invited (2)
                      </button>
                          ...
                          <div className="d-flex align-items-center justify-content-between my-3">
                            <div className="position-relative w-50">
                              ...
                              <Icon
                                ...
                                width={20}
                                height={20}
                                className="text-secondary position-absolute top-50 end-0 translate-middle-y me-3 cursor"
                              />
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="flex-grow-1">
                                    <div className="d-flex justify-content-between align-items-center">
                                      <h5 className="mb-0">
                                        Frontend Developer, Webflow, Wordpress,
                                        Shopify, Email Templates
                                      </h5>
                                      <div className="d-flex gap-2 align-items-start">
                                        <button
                                          type="button"
                                          className="btn btn-outline-primary btn-sm px-4 fs-12 btn-sm nowrap"
                                        >
                                          Hire
                                        </button>
                                        <button
                                          type="button"
                                          className="btn btn-primary btn-sm px-4 fs-12 btn-sm nowrap"
                                        >
                                          Invite
                                        </button>
                                      </div>
