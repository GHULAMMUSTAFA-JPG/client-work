        ...
        <>
            <div className='col-12'>
                <div className='d-flex justify-content-between align-items-center mb-3'>
                    ...
                    <button type="button" className="btn btn-outline-primary btn-sm rounded-pill px-3">View all Campaigns</button>
                </div>
            </div>
            <div className='col-md-4 col-xl-3'>
                <div className='card'>
                    <div className='card-body'>
                        ...
                        <span className='badge bg-primary-subtle text-primary rounded-pill fw-light border border-transparent mb-2'>In progress</span>
                        <p className='mb-1'>Full Stack Developer, ReactJS, NodeJS, MongoDB</p>
