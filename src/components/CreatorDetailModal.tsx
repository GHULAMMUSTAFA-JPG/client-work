  ...
  return (
    <>
      <div
        ...
        id="creatorDetailModal"
        tabIndex={-1}
        aria-labelledby="creatorDetailModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
          <div className="modal-content">
            <div className="modal-header px-4">
              <h1 className="modal-title fs-5" id="creatorDetailModalLabel">
                {selectedPost?.Post_Title || ""}
              </h1>
              <button
                type="button"
                id="close_modal_creator_detail"
                className="btn-close"
              ...
              <div className="row">
                ...
                <div className="col-md-7">
                  {selectedPost?.Media_Content?.length > 1 ? (
                    <div
                      id="creatorImageCarousel"
                      className="carousel slide"
                      data-bs-ride="carousel"
                    >
                      <div className="carousel-indicators">
                        {selectedPost?.Media_Content?.map(
                    ...
                    <div className="card-body">
                        ...
                        <span
                          className={
                            selectedPost?.Status == "Rejected"
                              ? "badge bg-danger-subtle fw-medium p-2 text-danger"
                              : selectedPost?.Status == "Pending Approval"
                              ? "badge text-yellow p-2 fw-medium bg-orange-subtle"
                              : "badge p-2 fw-medium text-primary bg-primary-subtle"
                          }
                        >
                          {selectedPost?.Status}
                        </span>
                      ...
                      <div className="mb-3">
                        ...
                        <textarea
                          ...
                          value={feedback} // Bind to the feedback state
                          onChange={handleFeedbackChange} // Update feedback state on input change
                        ></textarea>
                      </div>
                    </div>
                  </div>
