              ...
              <div className="row align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      ...
                      <p className="mb-0 text-warning fs-12 d-flex align-items-center">
                        <span className="fs-14 fw-medium  me-1">50</span>
                        Connections
                      </p>
                      <p className="mb-0 text-warning fs-12 d-flex align-items-center">
                        <span className="fs-14 fw-medium  me-1">30</span>
                        Followers
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-sm-6 col-md-6 col-xl-3">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      <p className="mb-0 text-warning fs-12 d-flex align-items-center">
                        <span className="fs-14 fw-medium  me-1">90</span>Total
                        Post
                      </p>
                      <p className="mb-0 text-warning fs-12 d-flex align-items-center">
                        <span className="fs-14 fw-medium  me-1">10</span>Post
                        Frequency
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-sm-6 col-md-6 col-xl-3">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      <p className="mb-0 text-warning fs-12 d-flex align-items-center">
                        <span className="fs-14 fw-medium  me-1">504.6</span>
                        Impressions
                      </p>
                      <p className="mb-0 text-warning fs-12 d-flex align-items-center">
                        <span className="fs-14 fw-medium  me-1">20.45</span>
                        Engagements
                      </p>
                    </div>
                  </div>
