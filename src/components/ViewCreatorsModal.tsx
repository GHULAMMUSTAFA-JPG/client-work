  ...
  return (
    <>
      <div
        ...
        id="viewCreatorsModal"
        tabIndex={-1}
        aria-labelledby="viewCreatorsModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
          <div className="modal-content">
            <div className="modal-header px-4">
              <h1 className="modal-title fs-5" id="viewCreatorsModalLabel">
                {data?.List_Name}
              </h1>
              <button
                type="button"
                    ...
                    <div className="card-body p-0">
                      <div className="table-responsive">
                        <table className="table align-middle text-center mb-0">
                          ...
                          <tbody>
                            {data?.List_Creators?.length !== 0 ? (
                              data?.List_Creators?.map((user: any) => (
                                <tr
                                  key={user?._id}
