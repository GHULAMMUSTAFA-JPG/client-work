  ...
  return (
    <>
      <div
        ...
        id="submitDetailModal"
        tabIndex={-1}
        aria-labelledby="submitDetailModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
          <div className="modal-content">
            <div className="modal-header px-4">
              <h1 className="modal-title fs-5" id="submitDetailModalLabel">
                {selectedPost?.Post_Title}
              </h1>
              <button
                type="button"
                id="close_modal_submit_detail"
                className="btn-close"
                      ...
                      <div className="d-flex align-items-center gap-2 mb-3">
                        ...
                        <div>
                          <h5 className="card-title mb-0 fs-14">
                            {campaignData?.campaign?.Creator_Name}
                          </h5>
                        ...
                        <span
                          className={
                            selectedPost?.Status == "Rejected"
                              ? "badge bg-danger-subtle end-0 fw-medium p-2 text-danger top-0"
