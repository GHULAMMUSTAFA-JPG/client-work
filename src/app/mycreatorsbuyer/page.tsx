                          ...
                          <div key={index} className="col-md-4 col-xl-3">
                            <div className="card">
                              <div className="card-body">
                                <div className="d-flex align-items-center justify-content-between mb-4">
                                  ...
                                  <div className="flex-shrink-0 ms-3">
                                    <span
                                      data-bs-toggle="modal"
                                      data-bs-target="#createNewListModal"
                                      className="d-inline-flex align-items-center justify-content-center rounded-circle bg-info bg-opacity-10 p-2 me-2 cursor"
                                      title="Edit"
                                      onClick={() => {
                                    ...
                                    <span
                                      ...
                                      className="d-inline-flex align-items-center justify-content-center rounded-circle bg-info bg-opacity-10 p-2 cursor"
                                      title="Delete"
                                    >
                                      <Icon
                                ...
                                <button
                                  type="button"
                                  className="btn btn-outline-info btn-sm w-100 rounded-pill"
                                  data-bs-toggle="modal"
