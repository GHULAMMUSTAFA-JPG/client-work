                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="d-flex align-items-center">
                                      ...
                                      <div className="ms-4">
                                        ...
                                        <p className="fs-12 text-orange mb-0">
                                          Waiting for Approvals
                                        </p>
                                      </div>
                                      <div className="ms-4">
                                        <p className="mb-0">3</p>
                                        <p className="fs-12 text-info mb-0">
                                          Hired
                                        </p>
                                      </div>
                                    </div>
                                  ...
                                  <td>
                                    ...
                                    <Icon
                                      ...
                                      width={24}
                                      height={24}
                                      className="text-warning cursor ms-3"
                                      onClick={() => {
                              ...
                              >
                                <div className="row">
                                  <div className="col-md-3">
                                    <div className="card bg-base">
                                      <div className="card-body">
                                        <span className="badge bg-orange text-white rounded-pill fw-light px-3 w-100 mb-2">
                                          Waiting Approval
                                        </span>
                                        <div className="card">
                                          <img
                              ...
                              >
                                <div className="row">
                                  <div className="col-md-3">
                                    <div className="card bg-base">
                                      <div className="card-body">
                                        <span className="badge bg-primary-subtle text-primary rounded-pill fw-light px-3 w-100 mb-2">
                                          Approved
                                        </span>
                                        <div className="card">
                                          <img
                              ...
                              >
                                <div className="row">
                                  <div className="col-md-3">
                                    <div className="card bg-base">
                                      <div className="card-body">
                                        <span className="badge bg-danger text-white rounded-pill fw-light px-3 w-100 mb-2">
                                          Rejected Post
                                        </span>
                                        <div className="card">
                                          <img
                              ...
                              >
                                <div className="row">
                                  <div className="col-md-3">
                                    <div className="card bg-base">
                                      <div className="card-body">
                                        <span className="badge bg-info text-white rounded-pill fw-light px-3 w-100 mb-2">
                                          Required Post
                                        </span>
                                        <div className="card">
                                          <img
