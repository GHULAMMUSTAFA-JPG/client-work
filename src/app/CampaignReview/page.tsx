...
function CampaignOverview({
  ...
  useEffect(() => {
    selectedCampaignDetails?.campaign &&
      getTotalElements(selectedCampaignDetails?.campaign?.Campaign_Progress);
  }, [selectedCampaignDetails]);
  ...
  return (
    <>
      {showActivatedCreators ? (
        <ActivatedCreators
          setShowActivatedCreators={setShowActivatedCreators}
                  ...
                  <div>
                    ...
                    <div className="d-flex align-items-center">
                      <p className="fs-12 text-warning mb-0">
                        {selectedCampaignDetails?.campaign?.Created_At}
                      </p>
                      <div className="vr mx-2 vr-public"></div>
                      <p className="fs-12 text-warning mb-0">
                        {selectedCampaignDetails?.campaign?.Time_Ago}
                      </p>
                      <div className="vr mx-2 vr-public"></div>
                      <span>
                        Budget:{" "}
                        <span className="fw-medium">
                          ${selectedCampaignDetails?.campaign?.Budget}
                        </span>
                      </span>
            ...
            <div className="row">
              ...
              <div className="col-md-3">
                <div
                  className="card"
                  style={{ cursor: "pointer" }}
                  onClick={() => setShowActivatedCreators(true)}
                >
                  <div className="card-body">
                    <div className="d-flex align-items-center mb-2">
                      <div className="rounded-circle bg-circle bg-circle3 p-2 me-2">
                      ...
                      inner_object !== "Applicants" && (
                        ...
                        >
                          ...
                          >
                            {
                              selectedCampaignDetails?.campaign
                                ?.Campaign_Progress?.[inner_object]?.length
                            }
                          </span>
                        </button>
                      )
                ...
                <table className="table align-middle">
                  ...
                  <tbody>
                    {(selectedTab == "All" && totalLenght !== 0) ||
                      ...
                      Object?.keys(
                        selectedCampaignDetails?.campaign?.Campaign_Progress
                      )?.map((inner_object: any) =>
                        selectedCampaignDetails?.campaign?.Campaign_Progress[
                          inner_object
                        ]?.map((array_item: any, index: number) => (
                          <tr
                            key={index}
                            style={
                              selectedTab == "All"
                          ...
                          >
                            ...
                            <td className="position-relative">
                              <div className="dropdown">
                                <span
                                  className={`px-2 py-1 rounded rounded-pill dropdown-toggle ${getStatusColor(
                                    inner_object
                                  )}`}
                            ...
                            <td className="text-center w-s ">
                              <Icon
                                ...
                                width={22}
                                height={22}
                                className="cursor text-warning text-center"
                                onClick={() => {
