                ...
                <div className='container-fluid'>
                    <div className='row my-3'>
                        <div className='col-12'>
                            <div className=''>
                                <ul className="nav nav-underline mb-3 border-bottom" id="active-submitted-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link active" id="active-campaigns-tab" data-bs-toggle="tab" data-bs-target="#active-campaigns" type="button" role="tab" aria-controls="active-campaigns" aria-selected="true">Active Campaigns ({campaigns?.Activated_Campaigns?.length || 0})</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link" id="submitted-campaigns-tab" data-bs-toggle="tab" data-bs-target="#submitted-campaigns" type="button" role="tab" aria-controls="submitted-campaigns" aria-selected="false">Submitted Campaigns ({campaigns?.Submitted_Campaigns?.length || 0})</button>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className='row'>
                                <div className='col-12 mb-2'>
                                    <div className="tab-content" id="myTabContent">
                                        <div className="tab-pane fade show active" id="active-campaigns" role="tabpanel" aria-labelledby="active-campaigns-tab" tabIndex={0}>
                                        ...
                                        <div className="tab-pane fade" id="submitted-campaigns" role="tabpanel" aria-labelledby="submitted-campaigns-tab" tabIndex={1}>
                                            <div className='row g-3 mb-3'>
                                                {
