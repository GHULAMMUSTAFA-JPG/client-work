                    ...
                    <div className='row my-3'>
                        <div className='col-12'>
                            <div className='d-flex align-items-center justify-content-between flex-wrap mb-3'>
                                ...
                                <select className="form-select custom-select mb-2" onChange={(e: any) => {
                                                ...
                                                <div className='d-flex justify-content-between gap-2 mb-4 align-items-center'>
                                                    ...
                                                    <div className='d-flex justify-content-between'>
                                                        <div className='d-flex justify-content-between  gap-2 align-items-center'>
                                                            <Icon icon="mdi:linkedin" width="18" height="18" className='text-info ms-2' style={{ minWidth: '18px', minHeight: '18px' }} />
                                                            <Icon icon="mdi:web" width="18" height="18" className='text-warning ms-1' style={{ minWidth: '18px', minHeight: '18px' }} />
                                                        </div>
